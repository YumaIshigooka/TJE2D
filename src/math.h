...
inline int clampInt(int a, int min, int max) { return a < min ? min : (a > max ? max : a); }
...
public:
	...
	Color operator / (float v) { return Color((unsigned char)(r / v), (unsigned char)(g / v), (unsigned char)(b / v)); }
	void operator /= (float v) { r = (unsigned char)(r / v); g = (unsigned char)(g / v); b = (unsigned char)(b / v); }
	Color operator + (const Color& v) { return Color((unsigned char)clampInt((int)r + (int)v.r, 0, 255), (unsigned char)clampInt((int)g + (int)v.g, 0, 255), (unsigned char)clampInt((int)b + (int)v.b, 0, 255)); }
	void operator += (const Color& v) { r += v.r; g += v.g; b += v.b; }
	Color operator - (const Color& v) { return Color((unsigned char)clampInt((int)r - (int)v.r, 0, 255), (unsigned char)clampInt((int)g - (int)v.g, 0, 255), (unsigned char)clampInt((int)b - (int)v.b, 0, 255));
	}
	void operator -= (const Color& v) { *this = *this - v; }
...
inline Color blendColors(const Color& a, const Color& b) { float f = 1.0f - a.a / 255.0f;  return Color((unsigned char)(a.r*(1.0f - f) + b.r*f), (unsigned char)(a.g*(1.0f - f) + b.g*f), (unsigned char)(a.b*(1.0f - f) + b.b*f)); }
...
inline Color operator * (const Color& a, const Color& b) { return Color( (unsigned int)((((float)a.r / 255.0f) * ((float)b.r / 255.0f)) * 255.0f),	(unsigned int)((((float)a.g / 255.0f) * ((float)b.g / 255.0f)) * 255.0f),	(unsigned int)((((float)a.b / 255.0f) * ((float)b.b / 255.0f)) * 255.0f));} //ignores alpha
